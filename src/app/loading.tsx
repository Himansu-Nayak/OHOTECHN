...
export default function Loading() {
  return (
    <div
      role="status"
      aria-live="polite"
      aria-label="Loading OHO TECH Platform"
      className="min-h-[70vh] w-full flex flex-col items-center justify-center bg-[#07080c] text-white px-4 py-16"
    >
      <div className="relative flex flex-col items-center max-w-xs w-full text-center">
        ...
        {/* Minimal OHO TECH Logo silhouette */}
        ...
        <p className="text-[11px] font-mono text-slate-400 mb-6 tracking-wide">
          INITIALIZING PLATFORM ARCHITECTURE
        </p>
