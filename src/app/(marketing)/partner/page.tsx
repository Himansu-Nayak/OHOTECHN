  ...
  return (
    <div className="bg-[#f7f7f5] text-[#0d0d0e] min-h-screen pb-16 pt-24 sm:pt-36 px-3 sm:px-6 lg:px-8 selection:bg-[#0d0d0e] selection:text-white">
      <main className="max-w-[1536px] w-full mx-auto" id="partner-main">
        ...
        {/* Hero Section */}
        <section className="bg-white border-2 border-slate-300 rounded-[32px] sm:rounded-[44px] p-6 sm:p-14 lg:p-20 shadow-sm text-center mb-10 relative overflow-hidden grid-pattern-light" id="partner-hero">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 flex items-center justify-center gap-4">
              <Link
                ...
                id="partner-hero-cta"
                className="w-full sm:w-auto min-h-[48px] px-8 py-4 rounded-full bg-[#0d0d0e] hover:bg-emerald-600 text-white font-extrabold text-xs sm:text-sm uppercase tracking-wider transition-all shadow-lg inline-flex items-center justify-center gap-2"
              >
        ...
        {/* Partner Paths */}
        <section className="bg-white border-2 border-slate-300 rounded-[32px] sm:rounded-[44px] p-6 sm:p-14 lg:p-20 shadow-sm mb-10" id="partner-paths-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {partnerTypes.map((type, index) => (
              <div
                key={index}
                className="p-6 sm:p-8 bg-[#fafafa] border-2 border-slate-200 hover:border-emerald-500 rounded-3xl transition-all duration-300 flex flex-col justify-between hover:shadow-lg group"
              >
                <div>
                  <span className="text-[10px] font-mono font-bold uppercase tracking-wider text-emerald-700 bg-emerald-50 px-3 py-1 rounded-full border border-emerald-200 inline-block mb-4">
                    {type.tag}
                  </span>
                  
                  <h3 className="text-xl font-bold text-[#0d0d0e] mb-3 group-hover:text-emerald-600 transition-colors">
                    {type.name}
                  </h3>
                ...
                <Link
                  href="/contact?subject=Partner Application"
                  className="w-full min-h-[48px] py-3.5 rounded-full bg-[#0d0d0e] hover:bg-emerald-600 text-white font-extrabold text-xs uppercase tracking-wider transition-all text-center flex items-center justify-center"
                >
        ...
        {/* Bottom CTA Banner */}
        <section className="bg-[#0d0d0e] text-white border-2 border-slate-700 rounded-[32px] sm:rounded-[44px] p-6 sm:p-14 lg:p-16 text-center shadow-2xl relative overflow-hidden" id="partner-bottom-cta">
