...
import { User, CheckCircle2, Quote, ShieldCheck, ArrowRight, Sparkles, Building2, Code2, ExternalLink } from 'lucide-react';
    ...
    <div className="bg-[#09090b] text-white min-h-screen pt-28 sm:pt-36 px-3 sm:px-6 lg:px-8 pb-16">
      ...
      <div className="relative isolate pt-24 lg:pt-32 pb-20 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          <ScrollReveal yOffset={25} duration={0.75} className="mx-auto max-w-3xl text-center">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
        <ScrollReveal yOffset={25} duration={0.7} className="mx-auto max-w-2xl text-center mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {values.map((val, idx) => (
            <ScrollReveal key={val.name} delay={idx * 0.08} yOffset={20} duration={0.6}>
              <Tilt3D maxTilt={4} scale={1.01} className="h-full">
                <div className="h-full p-8 rounded-3xl bg-[#141416] border border-white/10 hover:border-teal-500/40 transition-all flex flex-col justify-between">
                  <div>
