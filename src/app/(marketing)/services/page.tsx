...
export const metadata: Metadata = {
  title: 'Engineering & Digital Growth Services | OHO TECH',
  description: 'Full-stack software engineering, bespoke web & mobile applications, enterprise ERP integration, and data-driven digital growth strategies.',
};
          ...
          <section className="bg-white border-2 border-slate-300 rounded-[32px] sm:rounded-[44px] p-8 sm:p-14 lg:p-20 shadow-sm mb-10" id="tech-services-section">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="tech-services-grid">
              {techServices.map((service, index) => (
                <ScrollReveal key={service.slug} delay={index * 0.08} yOffset={24} duration={0.6}>
