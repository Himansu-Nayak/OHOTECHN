...
export const metadata: Metadata = {
  title: 'Industry Software Solutions | OHO TECH',
  description: 'Purpose-built software ecosystems and turnkey platforms for Healthcare, Education, Retail, Hospitality, Finance, Real Estate, and Fleet operations.',
};
        ...
        <section className="bg-white border-2 border-slate-300 rounded-[32px] sm:rounded-[44px] p-8 sm:p-14 lg:p-20 shadow-sm" id="solutions-grid-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" id="solutions-grid">
            {industries.map((industry, index) => (
              <ScrollReveal key={industry.slug} delay={index * 0.08} yOffset={24} duration={0.6}>
