  ...
  return (
    ...
    >
      ...
      <div className="bg-[#fafafa] border-2 border-slate-200 rounded-3xl p-8 sm:p-12 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-xs">
        ...
        <Link
          href="/book-demo"
          className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-[#0d0d0e] hover:bg-sky-600 text-white font-extrabold text-xs uppercase tracking-wider transition-all duration-200 shadow-lg shrink-0 group hover:scale-105"
        >
