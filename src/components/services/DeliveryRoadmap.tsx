...
const steps: PhaseStep[] = [
  ...
  },
  {
    ...
    desc: 'Crafting UI/UX prototypes, database schemas, and interactive system workflows.',
    timeframe: 'Phase 02 • Weeks 2 - 3',
    deliverables: 'Prototypes & Workflows',
    icon: Palette,
  },
  {
    step: '03',
    title: 'Agile Execution',
    desc: 'Building high-performance codebases with continuous integration and security.',
    timeframe: 'Phase 03 • Weeks 4 - 6',
    deliverables: 'Sprint Builds & Security',
    icon: Code2,
  },
  {
    step: '04',
    title: 'QA & Production Launch',
    desc: 'Comprehensive end-to-end testing, cloud server deployment, and handoff.',
