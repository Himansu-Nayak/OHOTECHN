  ...
  return (
    <>
      <Tilt3D maxTilt={4} scale={1.01} className="h-full">
        <div className="h-full group bg-[#141416] border border-white/10 rounded-2xl p-7 hover:border-emerald-400/60 hover:shadow-[0_0_25px_rgba(16,185,129,0.2)] transition-all duration-300 flex flex-col justify-between relative overflow-hidden">
          <div>
