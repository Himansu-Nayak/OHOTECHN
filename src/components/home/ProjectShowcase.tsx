      ...
      <div className={`grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center ${
        ...
        <div className={`lg:col-span-5 flex flex-col justify-between ${
          ...
          <div>
            ...
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-[-0.03em] leading-tight uppercase group-hover:text-emerald-400 transition-colors duration-300 mb-4">
              {project.title}
            </h3>
