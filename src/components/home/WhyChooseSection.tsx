            ...
            return (
              <ScrollReveal key={idx} delay={idx * 0.08} yOffset={20} duration={0.6}>
                <Tilt3D maxTilt={4} scale={1.01} className="h-full">
                  <div className="h-full p-5 sm:p-8 rounded-3xl bg-[#141416] border border-white/10 hover:border-emerald-400/60 hover:shadow-[0_0_25px_rgba(16,185,129,0.2)] transition-all duration-300 flex flex-col justify-between group backdrop-blur-xl">
                    <div>
