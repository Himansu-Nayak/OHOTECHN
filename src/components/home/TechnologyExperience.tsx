...
const FOUNDATION_PILLARS = [
  {
    number: '01',
    title: 'Deterministic Modular Runtimes',
    subtitle: 'ENGINEERING DEPTH',
    desc: 'Java 21 Spring Boot microservices, React 19 Next.js App Router, and native Swift/Kotlin frameworks built for predictable high throughput.',
    icon: Layers,
    metric: 'MICROSERVICES & NATIVE',
  },
  {
    number: '02',
    title: 'Isolated Data & ACID Persistence',
    subtitle: 'SOVEREIGN DATA INTEGRITY',
    desc: 'Dedicated PostgreSQL relational clustering, sub-millisecond Redis caching, and private pgvector embeddings with zero training leakage.',
    icon: Database,
    metric: 'STRICT ACID COMPLIANCE',
  },
  {
    number: '03',
    title: 'Resilient Cloud & Zero Downtime',
    subtitle: 'CONTINUOUS TELEMETRY & SLA',
    desc: 'Containerized Docker deployments, automated GitHub Actions CI/CD pipelines, and 24/7 health monitors backed by guaranteed enterprise SLAs.',
    icon: ShieldCheck,
    metric: '99.999% AVAILABILITY SLA',
  },
];
