...
export function FinalCTA({ onOpenEstimate }: FinalCTAProps) {
  return (
    <section 
      id="cta" 
      className="w-full bg-[#0a0a0b] text-white py-24 sm:py-32 lg:py-40 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto w-full text-center">
        ...
        <ScrollReveal yOffset={25} duration={0.8} delay={0.1}>
          <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black tracking-tighter text-white leading-[0.92] uppercase mb-6 sm:mb-8 select-none">
        ...
        <ScrollReveal yOffset={20} duration={0.7} delay={0.15}>
          <p className="text-sm sm:text-lg lg:text-xl text-slate-300 font-normal max-w-2xl mx-auto mb-10 sm:mb-14 leading-relaxed">
        ...
        <ScrollReveal yOffset={20} duration={0.7} delay={0.2}>
