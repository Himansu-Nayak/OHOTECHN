...
const PRODUCT_CATEGORIES = [
  { name: 'Hospital & Clinical EMR', icon: Activity, href: '/products?category=2', count: 'OPD / IPD / Lab' },
  { name: 'University & School ERP', icon: GraduationCap, href: '/products?category=1', count: 'Fees / Exams / LMS' },
  { name: 'Retail & Multi-Store POS', icon: Store, href: '/products?category=4', count: 'Barcode / Inventory' },
  { name: 'Enterprise Accounting', icon: Building2, href: '/products?category=3', count: 'Ledger / GST / Payroll' },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
          ...
          <div>
            <ScrollReveal yOffset={15} duration={0.6}>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-500/10 border border-sky-500/30 text-sky-400 font-mono text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-4">
                ...
                <span>COMMERCIAL SOFTWARE PLATFORMS</span>
              </div>
            </ScrollReveal>
            ...
            <TextReveal as="h2" splitType="words" className="text-3xl sm:text-5xl lg:text-6xl font-black text-white tracking-tight leading-tight uppercase">
              Production-Ready Turnkey Software
            </TextReveal>
          </div>
          
          <div className="max-w-md text-left md:text-right">
            <p className="text-sm sm:text-base text-slate-300 font-normal leading-relaxed mb-4">
              Explore 28+ pre-engineered enterprise software systems. Evaluate with interactive live demos or license turnkey deployments.
            </p>
            <Link
              href="/products"
        ...
        <div className="bg-gradient-to-r from-[#0f1118] via-[#121524] to-[#0f1118] border border-sky-500/30 rounded-[32px] p-6 sm:p-10 flex flex-col lg:flex-row items-center justify-between gap-6 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 shrink-0 w-full lg:w-auto">
            ...
            >
              <span>ACCESS SOFTWARE CATALOG</span>
