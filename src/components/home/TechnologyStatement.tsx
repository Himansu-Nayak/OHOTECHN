      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-4xl mx-auto mb-14 sm:mb-20">
          ...
          <ScrollReveal yOffset={22} duration={0.7} delay={0.1}>
            <div className="mb-4">
              <span className="text-xs sm:text-sm font-mono font-bold text-slate-400 tracking-[0.3em] uppercase block mb-3">
                INTEGRATED EXECUTION
              </span>
              <h2 className="text-3xl sm:text-6xl lg:text-7xl font-black text-white tracking-tight leading-[1.05] uppercase">
          ...
          <ScrollReveal yOffset={18} duration={0.65} delay={0.2}>
            <p className="text-sm sm:text-lg text-slate-300 leading-relaxed font-normal max-w-3xl mx-auto">
              At OHO TECH, we bridge long-term commercial strategy with human-centered spatial design and deterministic high-throughput software engineering. Every system we build removes operational friction and scales reliably.
            </p>
          </ScrollReveal>
        </div>
