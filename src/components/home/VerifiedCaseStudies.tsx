      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12 sm:mb-16 pb-8 border-b border-white/10">
          <div className="max-w-3xl">
            <ScrollReveal yOffset={15} duration={0.6}>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 font-mono text-[10px] sm:text-xs font-bold uppercase tracking-wider mb-4">
                ...
                <span>SELECTED WORK // FLAGSHIP PLATFORMS</span>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal yOffset={20} duration={0.7} delay={0.1}>
              ...
              <p className="text-sm sm:text-base text-slate-400 font-normal leading-relaxed">
                Representative enterprise platforms, custom software architectures, and scalable digital solutions engineered by OHO TECH.
              </p>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal yOffset={15} duration={0.6} delay={0.2}>
            <Link 
              href="/contact" 
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-emerald-500 hover:bg-emerald-400 text-black font-bold text-xs font-mono uppercase tracking-wider transition-all duration-200 shadow-lg shrink-0"
            >
