    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <ScrollReveal yOffset={24} duration={0.7} delay={0.15}>
          ...
          <h1 className="text-[clamp(2.75rem,8vw,8.5rem)] font-black tracking-tighter text-white leading-[0.9] mb-8 uppercase">
            <span className="block">WE BUILD</span>
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-300 to-cyan-400">DIGITAL</span>
