...
export function ERPStorySection() {
  ...
  return (
    <section className="max-w-[1536px] w-full mx-auto mb-16 bg-[#fafafa] border border-slate-200/80 rounded-[32px] sm:rounded-[44px] p-8 sm:p-14 lg:p-20 shadow-sm relative overflow-hidden transition-all duration-500" id="erp-story">
