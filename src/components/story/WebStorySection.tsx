...
export function WebStorySection() {
  const capabilities = [
    { title: 'Corporate Websites', desc: 'Brand-focused corporate sites engineered to position your business with authority.', icon: Globe },
    { title: 'E-Commerce Platforms', desc: 'High-conversion online commerce solutions built for seamless inventory & orders.', icon: ShoppingCart },
    { title: 'Customer Portals', desc: 'Secure web portals giving clients access to account management & services.', icon: Users },
    { title: 'Business Dashboards', desc: 'Custom administrative reporting tools to visualize key metrics in real time.', icon: Gauge },
    { title: 'Custom Web Applications', desc: 'Complex web platforms tailored to specific industry business models.', icon: Layout },
  ];

  return (
    <section className="max-w-[1536px] w-full mx-auto mb-16 bg-[#fafafa] border border-slate-200/80 rounded-[32px] sm:rounded-[44px] p-8 sm:p-14 lg:p-20 shadow-sm relative overflow-hidden transition-all duration-500" id="web-story">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-14">
        ...
        {/* Left Column: Visual on Left (Visually different from Section 01) */}
