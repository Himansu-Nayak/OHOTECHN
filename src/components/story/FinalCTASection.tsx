...
export function FinalCTASection() {
  return (
    <section className="max-w-[1536px] w-full mx-auto mb-16 bg-[#0d0d0e] text-white border border-black rounded-[32px] sm:rounded-[44px] p-10 sm:p-16 lg:p-20 text-center shadow-2xl relative overflow-hidden grid-pattern-dark">
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        <p className="text-slate-300 text-base sm:text-lg mb-10 max-w-xl mx-auto leading-relaxed">
          Tell us what you're looking to build or improve. We'll help you identify the right technology and the next step.
        </p>
