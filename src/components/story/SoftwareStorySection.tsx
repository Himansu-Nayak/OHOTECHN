...
export function SoftwareStorySection() {
  const capabilities = [
    { title: 'Custom Software Development', desc: 'Bespoke applications engineered around your exact operational workflows.' },
    { title: 'Business Applications', desc: 'Internal software tools that streamline day-to-day team productivity.' },
    { title: 'Enterprise Systems', desc: 'Robust software architecture designed to handle high transaction volume.' },
    { title: 'Software Modernization', desc: 'Upgrading legacy platforms to modern, scalable technology stacks.' },
    { title: 'Workflow Automation', desc: 'Eliminating repetitive manual processes with automated digital systems.' },
  ];

  return (
    <section className="max-w-[1536px] w-full mx-auto mb-16 bg-white border border-slate-200/80 rounded-[32px] sm:rounded-[44px] p-8 sm:p-14 lg:p-20 shadow-sm relative overflow-hidden transition-all duration-500" id="software-story">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-14">
        ...
        <div className="lg:col-span-7">
          ...
          <p className="text-base sm:text-lg text-slate-600 font-normal leading-relaxed mb-8 max-w-xl">
            We develop custom software and business applications designed around your workflows, operations, and goals.
          </p>
        ...
        <div className="lg:col-span-5 flex justify-center">
          <div className="w-full max-w-md bg-[#0d0d0e] text-white border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-sky-500/40 transition-all duration-300">
            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-6">
              ...
              <span className="text-[10px] font-mono text-sky-400 bg-sky-500/10 px-2.5 py-0.5 rounded border border-sky-500/20">
                Custom Architecture
              </span>
            </div>
            ...
            <div className="space-y-3 font-mono text-xs">
              ...
              <div className="p-3.5 rounded-xl bg-white/5 border border-white/10 flex items-center justify-between">
                ...
                <span className="text-[10px] text-emerald-400">Structured</span>
              </div>
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between text-[11px] font-mono text-slate-400">
              ...
              <span className="text-sky-400 font-bold">Scalable Stack</span>
            </div>
