...
import { ArrowRight, Palette, Plug, Layers, ShieldCheck } from 'lucide-react';

export function DesignIntegrationStorySection() {
  const capabilities = [
    { title: 'UI/UX Design', desc: 'User-centered interface design focused on clarity, accessibility, and task speed.' },
    { title: 'Product Design', desc: 'End-to-end product UX strategy, wireframing, component design & design systems.' },
    { title: 'API Integration', desc: 'Connecting custom software with payment gateways, CRMs, and messaging APIs.' },
    { title: 'Third-Party Integration', desc: 'Linking separate business tools together so data flows automatically.' },
    { title: 'System Modernization', desc: 'Refactoring legacy software user interfaces and connection layers.' },
  ];

  return (
    <section className="max-w-[1536px] w-full mx-auto mb-16 bg-white border border-slate-200/80 rounded-[32px] sm:rounded-[44px] p-8 sm:p-14 lg:p-20 shadow-sm relative overflow-hidden transition-all duration-500" id="design-integration-story">
        ...
        <div className="lg:col-span-5 flex justify-center">
          <div className="w-full max-w-sm bg-[#0d0d0e] text-white border border-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-sky-400 transition-all duration-300">
            ...
            <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between text-[11px] font-mono text-slate-400">
              ...
              <span className="text-sky-400 font-bold">Clean APIs</span>
            </div>
